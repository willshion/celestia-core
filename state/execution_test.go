...
import (
	...
	mmock "github.com/lazyledger/lazyledger-core/mempool/mock"
	tmproto "github.com/lazyledger/lazyledger-core/proto/tendermint/types"
	tmversion "github.com/lazyledger/lazyledger-core/proto/tendermint/version"
	"github.com/lazyledger/lazyledger-core/proxy"
	sm "github.com/lazyledger/lazyledger-core/state"
	"github.com/lazyledger/lazyledger-core/state/mocks"
...
func TestBeginBlockValidators(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		block, _ := state.MakeBlock(2, makeTxs(2), nil, nil,
			types.Messages{}, lastCommit, state.Validators.GetProposer().Address, nil)
