...
func TestBlockAddEvidence(t *testing.T) {
	...
	block := MakeBlock(h, txs, evList, nil, Messages{}, commit, nil)
...
func TestBlockHash(t *testing.T) {
	...
	assert.Nil(t, MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, Messages{}, nil, nil).Hash())
}

func TestBlockMakePartSet(t *testing.T) {
	assert.Nil(t, (*Block)(nil).MakePartSet(2))

	partSet := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, Messages{}, nil, nil).MakePartSet(1024)
...
func TestBlockMakePartSetWithEvidence(t *testing.T) {
	...
	partSet := MakeBlock(h, []Tx{Tx("Hello World")}, evList, nil, Messages{}, commit, nil).MakePartSet(512)
	assert.NotNil(t, partSet)
...
func TestBlockHashesTo(t *testing.T) {
	...
	block := MakeBlock(h, []Tx{Tx("Hello World")}, evList, nil, Messages{}, commit, nil)
...
func TestBlockSize(t *testing.T) {
	size := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, Messages{}, nil, nil).Size()
	if size <= 0 {
...
func TestBlockString(t *testing.T) {
	...
	block := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, Messages{}, nil, nil)
...
func TestBlockProtoBuf(t *testing.T) {
	...
	b1 := MakeBlock(h, []Tx{Tx([]byte{1})}, []Evidence{}, nil, Messages{}, &Commit{Signatures: []CommitSig{}}, nil)
	b1.ProposerAddress = tmrand.Bytes(crypto.AddressSize)

	b2 := MakeBlock(h, []Tx{Tx([]byte{1})}, []Evidence{}, nil, Messages{}, c1, nil)
	...
	b3 := MakeBlock(h, []Tx{}, []Evidence{}, nil, Messages{}, c1, nil)
